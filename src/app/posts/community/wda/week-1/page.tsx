...
export const metadata: PostMetaData = {
  ...
  title: "We Are Developers Academy: Week 1 - First Steps",
  date: "2023-11-08",
  author: {
  ...
  excerpt:
    "Diving into the first week of actual content at WDA. Learning experiences, challenges, and initial projects.",
};
